...
{
public:
  HikRobot(double exposure_ms, double gain, const std::string & vid_pid, unsigned int adcbitdepth = 8, double framerate = 265.0, bool trigger_mode = false);
  ~HikRobot() override;
